...
[See get started section with Opencensus](packages/workit-camunda/.docs/WORKER.md#add-traces-to-your-worker-with-opencensus)
...
-- | -- | -- 
3.2.x | 0.20.x < 0.20.1 | 7.6 to latest
